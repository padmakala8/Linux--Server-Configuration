...
### Server Details
Server IP Address 13.232.119.166

Hosted site Url [http://13.232.119.166.xip.io/](http://13.232.119.166.xip.io/)

### How to connect as grader:
  save private key provided in your local machine and run the following command
  ```
  ssh -i path/to/privatekey -p 2200 grader@13.232.119.166
  ```
